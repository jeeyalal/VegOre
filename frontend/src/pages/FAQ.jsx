                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <ChevronDown
                                                        className={`text-emerald-500 flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''
                                                            }`}
                                                        size={24}
                                                    />
                                                </button>
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a
                                ...
                                className="mt-2 inline-block bg-emerald-600 text-white px-10 py-5 rounded-lg text-sm font-semibold shadow hover:bg-emerald-700"
                            >
                                Email Us
                            </a>
                        </div>
