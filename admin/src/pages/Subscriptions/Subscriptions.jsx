            ...
            <div key={sub._id} className="subscription-card">
              ...
              <div className="subscription-customer">
                ...
                <p className="customer-email">
                  {sub.user?.email || sub.userDetails?.email}
                </p>
              ...
              <div className="subscription-address">
                <strong>📍 Delivery Address</strong>
                <p>
                  {sub.userDetails?.address}, {sub.userDetails?.city} -{' '}
                  {sub.userDetails?.pincode}
                </p>
              </div>
              ...
              <div className="subscription-badges">
                ...
                <span className={`payment-badge payment-${sub.paymentStatus}`}>
                  {sub.paymentStatus}
                </span>
              </div>
              ...
              <div className="subscription-controls">
                ...
                <div className="control-group">
                  ...
                  <select
                    value={
                      paymentStatusMap[sub._id] ?? sub.paymentStatus
                    }
                    onChange={(e) =>
                      setPaymentStatusMap((s) => ({
                        ...s,
                        [sub._id]: e.target.value,
                      }))
                    }
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      const updates = {
                        status: statusMap[sub._id] ?? sub.status,
                        paymentStatus:
                          paymentStatusMap[sub._id] ??
                          sub.paymentStatus,
                      }
